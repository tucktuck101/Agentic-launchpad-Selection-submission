...
This repository is the submission artefact. Use this path to review the work without treating the supplied template as the only evidence.

## Review Path

1. Start with `agentic-launchpad-selection-submission.md` for the required template summary.
2. Read `README.md` for repository structure, setup notes, and CI context.
