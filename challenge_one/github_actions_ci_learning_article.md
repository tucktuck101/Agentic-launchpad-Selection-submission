  ...
  python-check:
    ...
    steps:
      ...
      - name: Compile Python files
        run: |
          python -m py_compile challenge_two/task_4_api_script/api-script-server/server.py
  ...
  javascript-check:
    ...
    steps:
      ...
      - name: Check JavaScript syntax
        run: |
          node --check challenge_two/task_1_code_review/code-review-app/server/index.js
          node --check challenge_two/task_5_failing_tests/server.js
          node --check challenge_two/task_5_failing_tests/parcelRules.js
```
...
- name: Set up Node
  ...
  with:
    node-version: 18
    cache: npm
    cache-dependency-path: challenge_two/task_5_failing_tests/package-lock.json
```
